export const FONTS = {
  ...
  h4: "normal 700 20px/20px 'Spoqa Han Sans Neo', 'sans-serif'",
  h5: "normal 700 18px/18px 'Spoqa Han Sans Neo', 'sans-serif'",
  h6: "normal 700 16px/16px 'Spoqa Han Sans Neo', 'sans-serif'",

  h4p: "normal 300 16px/16px 'Spoqa Han Sans Neo', 'sans-serif'",
  h6p: "normal 300 14px/14px 'Spoqa Han Sans Neo', 'sans-serif'",
  p: "normal 400 16px/16px 'Spoqa Han Sans Neo', 'sans-serif'",
